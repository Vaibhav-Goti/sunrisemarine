  ...
  <div class="site-wrap">
        ...
        <div class="row align-items-center">
          <div class="col-6 col-lg-3">
            <a href="index.php" class="d-flex align-items-center">
              <img src="images1/logo.png" alt="Sunrise Marine Logo" class="img-fluid mr-2" style="max-height: 80px; width: auto;">
              <span class="h4 mb-0"><strong>Sunrise </strong>Marine Enterprise</span>
            </a>
          </div>
          ...
          <div class="col-md-5">
            ...
            <form action="process_quote.php" method="POST" class="row">
              ...
              <div class="form-group col-md-12">
                ...
                <div class="g-recaptcha mb-3" data-sitekey="6LeyQsQrAAAAAHrUNJ0cZuKK9J-mUfd6T81Hq8Do"></div>
              </div>
    ...
    <div class="footer bg-light">
      <div class="container">
        <div class="row">
          <div class="col-lg-3">
            <p class="mb-4"><img src="images1/logo.png" alt="Sunrise Marine Logo" class="img-fluid" style="max-height: 60px; width: auto;">Sunrise Marine Enterprise</p>
